...
class AddRecipeView extends View {
  ...
  constructor() {
    super();
    this._addHandlerShowWindow(); // runs when the object is created.
    this._addHandlerHideWindow(); // runs when the object is created.
  }
  ...
  addHandlerUpload(handler) {
    this._parentElement.addEventListener("submit", function (e) {
      ...
      const data = Object.fromEntries(dataArr); // Converts an array of key-value pairs into an object.
      handler(data); // controlAddRecipe
    });
  }
